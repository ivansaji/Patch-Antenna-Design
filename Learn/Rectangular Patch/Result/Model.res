...
lifetime=s:solverstart
result=s:0
treepath=s:Mesh\Information
files=s:TLMMeshFeedback.rex
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Input Impedances\Port 1
files=s:pzc1.sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [1]\Loss per Solid\component1\Volume loss in substrate
files=s:cLoss_in_component1[a]substrate(1).sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [1]\Loss per Solid\component1\Metal loss in ground_plane
files=s:cLoss_in_component1[a]ground_plane(1).sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [1]\Loss per Solid\component1\Metal loss in patch
files=s:cLoss_in_component1[a]patch(1).sig
...
files=s:MS\Model_results\Model.f001.es
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Power Flow\power (f=1.8) [1]
files=s:power (f=1.8) [1].rex
ylabel=s:power (f=1.8) [1]
...
files=s:surface current (f=1.8) [1].rex
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Surface Power Loss Dens.\loss (f=1.8) [1]
files=s:surface-loss (f=1.8) [1].rex
ylabel=s:loss (f=1.8) [1]
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Power Loss Dens.\loss (f=1.8) [1]
files=s:loss (f=1.8) [1].rex
ylabel=s:loss (f=1.8) [1]
